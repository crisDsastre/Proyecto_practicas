...
import 'package:traffic_counter_nueva_interfaz/pages/detection_history/bloc/detection_history_event.dart';
...
class MyDetectionsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create:
          (context) =>
              DetectionHistoryBloc()
                ..add(LoadDetections()), // Lanza carga al abrir
      child: Scaffold(
